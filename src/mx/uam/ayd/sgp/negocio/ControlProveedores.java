...
import mx.uam.ayd.sgp.presentacion.VentanaA�adirProveedor;
...
public class ControlProveedores {
	...
	private VentanaA�adirProveedor GUIAddProv;
	...
	public void VentanaA�adirProveedor() {
		GUIAddProv = new VentanaA�adirProveedor(this);
