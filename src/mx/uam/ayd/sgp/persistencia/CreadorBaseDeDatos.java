...
public class CreadorBaseDeDatos {
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			statement.execute("create table Usuarios(idempleado INT PRIMARY KEY,usuario varchar(40), contraseña varchar(40),tipoCuenta varchar(20),nombre varchar(40),apellidos varchar(100),telefono varchar(40))");// , CONSTRAINT primary_key PRIMARY KEY (autorId)
