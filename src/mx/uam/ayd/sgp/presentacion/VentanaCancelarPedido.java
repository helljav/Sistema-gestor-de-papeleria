...
public class VentanaCancelarPedido extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaCancelarPedido(ControlVentaPedido ctrlPedido) {
		setUndecorated(true);
		this.controlPedido = ctrlPedido;
		...
		textField.setPlaceholder("Ingrese nombre del cliente para buscar su pedido");
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String nombreCliente = textField.getText().toUpperCase();
				pedido = controlPedido.buscarPedido(nombreCliente);
				if (pedido != null) {
					lblMostrarP.setText(pedido.toString()); // Muestra el nombre del autor actualmente
																// seleccionado
				}
		...
		JLabel lblEliminarProductoDel = new JLabel("Cancelar Pedido");
