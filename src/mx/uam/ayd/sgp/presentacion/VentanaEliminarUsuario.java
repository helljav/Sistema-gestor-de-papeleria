...
public class VentanaEliminarUsuario extends JFrame {
	...
	public VentanaEliminarUsuario(ControlAdminUsuario ctrl1) {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\u00EDndice.jpg"));
		...
		/**
		 * Caracteristicas y funciones del boton buscar
		 */
		...
		btnBuscarusuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String UsuarioBuscar = textField_1.getText();
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup().addGap(29).addGroup(gl_contentPane
						.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addComponent(lblEliminarUsuario)
								.addContainerGap())
						.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
								.createParallelGroup(Alignment.LEADING)
								.addComponent(MostrarU, GroupLayout.PREFERRED_SIZE, 424, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(textField_1, GroupLayout.PREFERRED_SIZE, 281,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18).addComponent(btnBuscarusuario, GroupLayout.PREFERRED_SIZE, 142,
												GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(btnEliminarUsuario, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
				.createSequentialGroup().addGap(16).addComponent(lblEliminarUsuario).addGap(18)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
						.addComponent(btnBuscarusuario, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addComponent(textField_1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addGap(15).addComponent(MostrarU, GroupLayout.PREFERRED_SIZE, 245, GroupLayout.PREFERRED_SIZE)
				.addGap(49)
		...
		/*
		 * 
		 * JLabel IconStarShop = new JLabel(""); IconStarShop.setIcon(new
		 * ImageIcon("C:\\Users\\980006502\\Pictures\\StarShop\\stara.png"));
		 * IconStarShop.setBounds(250, 35, 250, 108); contentPane.add(IconStarShop);
		 */
	}
