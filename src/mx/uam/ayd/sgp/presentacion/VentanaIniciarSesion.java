...
public class VentanaIniciarSesion extends javax.swing.JFrame {
	...
	public VentanaIniciarSesion(ControlAutenticacionUsusario ctrl) {
		...
		panelImage1.setIcon(new ImageIcon(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\img1.png")); // NOI18N

		javax.swing.GroupLayout panelImage1Layout = new javax.swing.GroupLayout(panelImage1);
		panelImage1.setLayout(panelImage1Layout);
		panelImage1Layout.setHorizontalGroup(panelImage1Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 175, Short.MAX_VALUE));
		...
		// panelImage2.setIcon(new
		// javax.swing.ImageIcon(getClass().getResource("/img/campos.png"))); // NOI18N

		panelImage3.setIcon(new ImageIcon(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\icono1.png")); // NOI18N

		javax.swing.GroupLayout panelImage3Layout = new javax.swing.GroupLayout(panelImage3);
		panelImage3.setLayout(panelImage3Layout);
		panelImage3Layout.setHorizontalGroup(panelImage3Layout
		...
		panelImage2Layout
				.setHorizontalGroup(panelImage2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelImage2Layout.createSequentialGroup().addContainerGap()
								...
								.addContainerGap()));
		panelImage2Layout.setVerticalGroup(panelImage2Layout
		...
		// panelImage4.setIcon(new
		// javax.swing.ImageIcon(getClass().getResource("/img/campos.png"))); // NOI18N

		panelImage5.setIcon(new ImageIcon(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\password1.png")); // NOI18N

		javax.swing.GroupLayout panelImage5Layout = new javax.swing.GroupLayout(panelImage5);
		panelImage5.setLayout(panelImage5Layout);
		panelImage5Layout.setHorizontalGroup(panelImage5Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 27, Short.MAX_VALUE));
		panelImage5Layout.setVerticalGroup(panelImage5Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 32, Short.MAX_VALUE));
		...
		panelImage4Layout.setHorizontalGroup(panelImage4Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(panelImage4Layout.createSequentialGroup().addContainerGap()
						.addComponent(panelImage5, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtContraseña, GroupLayout.DEFAULT_SIZE, 251, Short.MAX_VALUE)
						.addContainerGap()));
		panelImage4Layout.setVerticalGroup(panelImage4Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(panelImage4Layout.createSequentialGroup().addContainerGap()
						.addGroup(panelImage4Layout.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(txtContraseña, Alignment.LEADING).addComponent(panelImage5,
		...
		// panelImage6.setIcon(new
		// javax.swing.ImageIcon(getClass().getResource("/img/acerca.png"))); // NOI18N

		javax.swing.GroupLayout panelImage6Layout = new javax.swing.GroupLayout(panelImage6);
		panelImage6.setLayout(panelImage6Layout);
		panelImage6Layout.setHorizontalGroup(panelImage6Layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 0, Short.MAX_VALUE));
		panelImage6Layout.setVerticalGroup(panelImage6Layout
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING).addGroup(jPanel1Layout
				...
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
						.addComponent(panelImage4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(panelImage2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(0, 57, Short.MAX_VALUE))
				.addGroup(jPanel1Layout.createSequentialGroup()
						.addComponent(jLabel1, GroupLayout.DEFAULT_SIZE, 428, Short.MAX_VALUE).addContainerGap())
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(131)
						.addComponent(panelImage1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED, 132, Short.MAX_VALUE).addComponent(panelImage6,
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout
				...
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
						.addComponent(panelImage6, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(panelImage1,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
				.addGap(24).addComponent(jLabel1).addGap(18)
				.addComponent(panelImage2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(
						panelImage4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(45)
				.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
