...
public class VentanaPrincipalEmpleado extends JFrame {
	...
	public VentanaPrincipalEmpleado(ControlVEmpleado ctrl) {
		...
		lblElegirAlmacen.setIcon(new ImageIcon(
				path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\icons8-producto-nuevo-64 empleado.png"));
		...
		labelRealizarVenta.setIcon(new ImageIcon(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\bienes.png"));
		...
		lblRealizarPedido
				.setIcon(new ImageIcon(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\pedido-online.png"));
		...
		lblConsultaVentas.setIcon(new ImageIcon(
				path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\Query_icon-icons.com_53746 - empleado.png"));
		...
		lblAdministrarUsuarios
				.setIcon(new ImageIcon(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\usuario - empleado.png"));
		...
		lblCerrarSesion.setIcon(new ImageIcon(path + "\\src\\mx\\uam\\ayd\\sgp\\presentacion\\img\\Logout_37127.png"));
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(216)
						.addComponent(lblElegirAlmacen, GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE).addGap(202))
				.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
						.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup().addGap(29).addComponent(labelRealizarVenta,
								GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE))
						.addGroup(gl_contentPane.createSequentialGroup().addContainerGap().addComponent(
								lblConsultaVentas, GroupLayout.PREFERRED_SIZE, 167, GroupLayout.PREFERRED_SIZE)))
						.addGap(172)
						...
						.addGap(23))
				.addGroup(gl_contentPane.createSequentialGroup().addGap(206)
						.addComponent(lblCerrarSesion, GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE).addGap(212)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addGap(41).addComponent(labelRealizarVenta,
