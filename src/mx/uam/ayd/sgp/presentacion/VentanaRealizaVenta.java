...
public class VentanaRealizaVenta extends JFrame {
	 ...
	 * 
	 * @param ctrl  es una instancia de Control Realizar Venta
	 */
	 ...
	 * @param numero
	 *            Consiste en el valor que puedes asignar: 1 si es exito 0 si es error para ubicar el tipo de imagen que va a mostrar la ventana.
	 */
