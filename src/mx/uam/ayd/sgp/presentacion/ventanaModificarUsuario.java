...
public class ventanaModificarUsuario extends JFrame {
	...
	public ventanaModificarUsuario(ControlAdminUsuario ctrlU) {
		...
		txtUsuario.setPlaceholder("Ingrese el nombre de Usuario o Id del empleado para buscar");
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					usuarioAnterior = new Usuario(usuario.getUsuario(), usuario.getContraseña(),
							usuario.getTipoCuenta(), usuario.getNombre(), usuario.getApellidos(), usuario.getTelefono(),
							Integer.parseInt(usuario.getIdEmpleado()));
					System.out.println("\n\n neta no carnal " + usuarioAnterior.toString() + "\n\n");

					// nuevos datos cargados desde la caja de texto
					String contraseña = textContraseña.getText();
					String tipoCuenta = textTipoCuenta.getText();
					...
					Usuario nUsuario = new Usuario(usuario, contraseña, tipoCuenta.toUpperCase(), nombre.toUpperCase(),
							apellidos.toUpperCase(), telefono, Integer.parseInt(idEmpleado));
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(lblidEmpleado).addComponent(lblTelefono)
										.addComponent(lblApellidos).addComponent(
												lblNombre)
										.addComponent(lbltipoCuenta).addComponent(lblContraseña)
										.addComponent(lblUsuario))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(textContraseña, GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
										.addComponent(textTipoCuenta, GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
										.addComponent(textNombre, GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
										.addComponent(textApellidos, GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
										.addComponent(textTelefono, GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
										.addComponent(textidEmpleado, GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
										.addComponent(txtUsuario, GroupLayout.PREFERRED_SIZE, 436,
												GroupLayout.PREFERRED_SIZE))))
				.addGap(51))
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addComponent(lblModificarUsuario, GroupLayout.DEFAULT_SIZE, 570, Short.MAX_VALUE)
						.addContainerGap())
				.addGroup(Alignment.TRAILING,
						gl_contentPane.createSequentialGroup().addContainerGap(239, Short.MAX_VALUE)
								.addComponent(buttonBuscar, GroupLayout.PREFERRED_SIZE, 156, GroupLayout.PREFERRED_SIZE)
								.addGap(222)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addContainerGap().addComponent(lblModificarUsuario).addGap(33)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblUsuario)
						.addComponent(txtUsuario, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE))
				.addGap(19)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblContraseña)
						.addComponent(textContraseña, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lbltipoCuenta)
						.addComponent(textTipoCuenta, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				...
				.addGroup(gl_contentPane
						.createParallelGroup(Alignment.TRAILING).addComponent(lblApellidos).addComponent(textApellidos,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblTelefono).addComponent(
						textTelefono, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblidEmpleado)
						.addComponent(textidEmpleado, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
